...
Class UsuariosMDB{
    ...
    public function obtenerRegistros(){
        try{
            ...
            foreach($rows as $row){
                echo "ID: $row->_id - Nombre completo: $row->nombre $row->apellido - E-mal: $row->email - Edad: $row->edad <br>";
            }
        }catch(MongoDB\Driver\Exception\Exception $e){
            echo "Ocurrio la siguiente excepcion al tratar de leer el registro: ".$e->getMessage()."\n";
        }
    }
